...
public class DocAdministratifJoindreController {
    ...
    public void uplaodImage(
                            ...
                            @RequestParam("radiographiePulmonaire") MultipartFile radiographiePulmonaire) throws IOException {
    ...
    public Image getImage(@PathVariable("imageFile") String imageName) throws IOException {
